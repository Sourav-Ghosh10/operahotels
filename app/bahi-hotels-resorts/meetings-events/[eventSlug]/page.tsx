...
export async function generateMetadata({ params }: { params: Promise<{ eventSlug: string }> }) {
    ...
    return {
        title: eventData?.seo?.meta_title || eventData?.title || 'Meeting & Event Space | Bahi Hotels & Resorts',
                ...
                <div className="container">
                    <ol className="breadcrumb m-0 small text-uppercase fw-bold" style={{ letterSpacing: '1px' }}>
                        <li className="breadcrumb-item">
                            <Link href="/bahi-hotels-resorts" className="text-decoration-none" style={{ color: '#888' }}>Home</Link>
                        </li>
                        <li className="breadcrumb-item">
                            <Link href="/bahi-hotels-resorts/meetings-events" className="text-decoration-none" style={{ color: '#888' }}>Meetings &amp; Events</Link>
                        </li>
